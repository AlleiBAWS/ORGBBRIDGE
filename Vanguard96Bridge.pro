...
HEADERS +=                                                                                      \
    Vanguard96Bridge.h                                                                       \
    Vanguard96Controller.h                                                                      \
	
SOURCES +=                                                                                      \
    Vanguard96Bridge.cpp                                                                     \
    Vanguard96Controller.cpp                                                                    \
...
#-----------------------------------------------------------------------------------------------#
# hidapi (för att prata HID med tangentbordet)                                                  #
#-----------------------------------------------------------------------------------------------#
INCLUDEPATH += $$PWD/deps/hidapi/include
LIBS        += -L$$PWD/deps/hidapi/lib -lhidapi
